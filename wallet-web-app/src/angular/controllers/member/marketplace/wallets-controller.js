...
function MarketplaceWalletsController($rootScope, $scope, $log, $mdDialog, ElectronService, ConfigStorageService, CommonService, $http, $timeout, $sce, $injector) {
    'ngInject'

    $log.info('MarketplaceWalletsController starting ...');
    ...
    function fetchAirtableData() {
      let apiURL = "https://alpha.selfkey.org/marketplace/i/api/bank-accounts";
      // console.log(apiURL);
    ...
    $scope.openModal = function(data, title) {
      $scope.modalData = {
        'items': data,
        'title': title
      }
